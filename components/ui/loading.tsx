...
export function Loading({
  ...
  if (fullScreen) {
    return (
      <div className={cn(
        'fixed inset-0 z-[60] flex items-center justify-center bg-background/95 backdrop-blur-sm',
        className
      )}>
        {content}
      </div>
...
// Logo-only by default (no text) so there's only ONE full-screen loading look.
